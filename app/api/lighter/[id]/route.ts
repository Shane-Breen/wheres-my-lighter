...
export async function POST(
  req: Request,
  { params }: { params: Promise<{ id: string }> } // ✅ Next 15 compatible
) {
  try {
    ...
    const insertPayload = {
      ...
      lng: body.lng,
      accuracy_m:
        typeof body.accuracy_m === "number" ? body.accuracy_m : null,
      city: body.city ?? null,
      country: body.country ?? null,

      // IMPORTANT:
      // Do NOT send place_label here (your DB/schema has been changing and it's causing PGRST204 errors)
    };
